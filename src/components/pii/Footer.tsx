...
export const Footer = () => {
  return (
    <footer className="mt-16 bg-gradient-to-r from-[#0E2954] via-[#1F6E8C] to-[#2E8A99] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* AI Safety Tips */}
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Shield className="w-5 h-5 text-[#84A7A1]" />
              <h3 className="text-lg font-semibold">AI Safety Tips</h3>
            </div>
            <ul className="space-y-2 text-sm text-slate-200">
              <li className="flex items-start gap-2">
                <Lock className="w-4 h-4 mt-0.5 text-[#84A7A1] flex-shrink-0" />
                Always anonymize personal data before sharing with AI
              </li>
              <li className="flex items-start gap-2">
                <Eye className="w-4 h-4 mt-0.5 text-[#84A7A1] flex-shrink-0" />
                Review all outputs before using them
              </li>
              <li className="flex items-start gap-2">
                <AlertTriangle className="w-4 h-4 mt-0.5 text-[#84A7A1] flex-shrink-0" />
          ...
          <div>
            ...
            <div className="bg-[#0E2954]/50 p-4 rounded-lg border border-[#84A7A1]/30">
        ...
        <div className="border-t border-[#84A7A1]/30 mt-8 pt-8 text-center">
